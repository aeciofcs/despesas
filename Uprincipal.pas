...
uses
   ...
   bsPngImageList, dxSkinsCore, dxSkinBlack, dxSkinBlue, dxSkinCaramel,
...
begin
   ...
   {$REGION 'Verificando Campos novos'}
   ...
   Case paggrafico.activepageIndex Of
      ...
      2:
         Begin
            ...
            QryDespTipoPagamento.Close;
            QryDespTipoPagamento.SQL.Text := 'Select Tpg.Descricao, ' + '             Min(pago) as Pago, ' +
