...
begin
   ...
   Begin
      ...
      Begin
         QryModific.Sql.Text := 'Insert Into T_Despesas ' + '(Sequencia,Cod_TipoDespesa, Cod_ContaCorrente,' +
            'Historico,D_C,Valor,Data_lancamento,Data_Vencimento, Cod_TipoPagamento,Pago,Recebido,nr_parcela ) Values ' +
            '(:ParSequencia,:ParCod_TipoDespesa, :ParCod_ContaCorrente, ' + ':ParHistorico,:ParD_C,:ParValor,:ParData_lancamento, ' +
            ':ParData_Vencimento,:ParCod_TipoPagamento,:parpago,:parRecebido,:parnr_parcela  )';
